...
{
?>
	<form method="post"><button name="update" value="onoff">ONOFF Senden</button></form><br />
	Note: Can only switch heater off if on, if heater is off, it will get in an interesting different state :o<br />
	<form method="post"><button name="update" value="onoffPlus">ONOFF mit UP Senden</button></form><br />
